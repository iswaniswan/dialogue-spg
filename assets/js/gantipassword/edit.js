...
var Detail = $(function() {
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td><select data-urut="${i}" required class="form-control form-control-sm form-control-select2" data-container-css-class="select-sm" name="i_customer[]" id="i_customer${i}" required data-fouc></select></td>`;
