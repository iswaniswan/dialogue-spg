                                    ...
                                    if ($detail) {
                                        foreach ($detail->result() as $key) {
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td>
                                                    <select data-urutan="<?= $i; ?>" required class="form-control form-control-sm form-control-select2" data-container-css-class="select-sm" name="i_company[]" id="i_company<?= $i; ?>" required data-fouc>
                                                        <option value="<?php /* echo $key->i_company */; ?>"><?php /* echo $key->e_company_name */; ?></option>
                                                    </select>
                                                </td> -->
                                                <td>
                                                ...
                                                <td><input type="number" required class="form-control form-control-sm" min="1" id="qty<?= $i; ?>" value="<?= $key->n_qty; ?>" placeholder="Qty" name="qty[]"></td>
                                                <td>
                                                    <select required class="form-control form-control-sm form-control-select2" data-container-css-class="select-sm" name="i_alasan[]" id="i_alasan<?= $i; ?>" required data-fouc>
                                                ...
                                                <td><input type="file" class="form-control" id="foto<?= $i; ?>" placeholder="Foto" name="foto<?= $i; ?>" ></td>
                                                <td><input type="hidden" class="form-control form-control-sm" id="fotolama<?= $i; ?>" name="fotolama<?= $i; ?>" value="<?= $key->foto; ?>">
                                                    <input type="hidden" class="form-control form-control-sm" id="fotosrc<?= $i; ?>" name="fotosrc<?= $i; ?>" value="<?= base_url().'./upload/images/'.$key->foto; ?>">
                                                    <b><i title="Lihat Foto" class="icon-eye text-primary lihatfoto" data-toggle="modal" data-target="#imageModal" id="<?= $i; ?>"></i></b></td>
