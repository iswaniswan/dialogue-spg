...
<body>
	...
	<!-- Main navbar -->
	<div class="navbar navbar-expand-md navbar-dark bg-slate-800 fixed-top" style="padding: 0px 1.1rem;">
        <div class="navbar-brand wmin-200" style="padding-top: 0.5rem;padding-bottom: 0.00002rem;min-width: 7.625rem;">
            <a href="#" class="d-inline-block">
                <img src="global_assets/images/logo_light.png" title="Dashboard" style="height: 2.7rem;width: 6.5rem;margin-bottom: 0.5rem;margin-top: -0.4rem;">
            </a>
        </div>
			...
			<div class="navbar navbar-expand-lg navbar-light">
				...
				<div class="navbar-collapse collapse" id="navbar-footer">
					<span class="navbar-text">
						&copy; 2021 - <?= date('Y');?>. <a href="#">Management Information System</a> <!-- <a href="http://themeforest.net/user/Kopyov" target="_blank">Eugene Kopyov</a> -->
					</span>
