        ...
        <div class="card-body">
            <form class="form-validation">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-capitalize" placeholder="Entry Level" id="elevel" name="elevel"
                        maxlength="30" autocomplete="off" required autofocus>
                </div>
                <div class="form-group">
                    <label>Deskripsi :</label>
                    <textarea class="form-control" placeholder="Deskripsi Level .." name="deskripsi"></textarea>
                </div>
