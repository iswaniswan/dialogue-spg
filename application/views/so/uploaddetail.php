                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-columned datatable-header-basic table-bordered table-xs demo2" id="tabledetail">
                                ...
                                <tbody>
                                    <?php $i = 0; foreach ($datadetail as $key) { $i++; ?>
                                        <tr>
                                            ...
                                            <td class="d-none">
                                                <input type="text" readonly required 
                                                        class="form-control form-control-sm product input-product"
                                            ...
                                            <td><?= $key["brand"]; ?></td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm product"
                                                    name="items[<?= $i ?>][qty]" value="<?= $key["qty"] ?>">
                                            </td>                                            
                                        </tr>
                                    <?php } ?>
