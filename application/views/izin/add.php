        ...
        <div class="card-body">
            <form class="form-validation">
                <div class="form-group">
                    <label><?= $this->lang->line('Jenis Izin'); ?> :</label>
                    <input type="text" class="form-control text-capitalize" placeholder="<?= $this->lang->line('Ketik'); ?> <?= $this->lang->line('Jenis Izin'); ?>" id="e_izin_name" name="e_izin_name" maxlength="30" autocomplete="off" required autofocus>
                </div>
