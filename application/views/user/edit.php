                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-lowercase" autofocus placeholder="<?= $this->lang->line('Username'); ?>" name="username" maxlength="255" autocomplete="off" required value="<?= $data->username; ?>">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-capitalize" autofocus placeholder="<?= $this->lang->line('Nama Lengkap'); ?>" name="ename" maxlength="255" autocomplete="off" required value="<?= $data->e_nama; ?>">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-switch form-check-switch-left">
                                <input type="checkbox" name="fallcustomer" data-on-text="Yes" data-off-text="No" <?php if ($data->f_allcustomer == 't') { ?> checked <?php } ?> class="form-input-switch">
                            </div>
                        </div>
                    </div>
                    <!--
