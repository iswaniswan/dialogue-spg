        ...
        <div class="card-body">
            <form class="form-validation">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="<?= $this->lang->line('Ketik'); ?> <?= $this->lang->line('Nama Perusahaan'); ?>" id="ecompany" name="ecompany" maxlength="30" autocomplete="off" required onkeyup="gede(this);" autofocus>
                </div>
