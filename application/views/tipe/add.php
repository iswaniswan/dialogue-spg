        ...
        <div class="card-body">
            <form class="form-validation">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-capitalize" placeholder="<?= $this->lang->line('Ketik'); ?> <?= $this->lang->line('Nama Tipe'); ?>" id="etype" name="etype" maxlength="30" autocomplete="off" required autofocus>
                </div>
