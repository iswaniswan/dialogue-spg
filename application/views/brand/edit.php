        ...
        <div class="card-body">
            <form class="form-validation">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="itype" name="itype" value="<?= $data->id_brand; ?>">
                    <input type="hidden" class="form-control" id="etypeold" name="etypeold" value="<?= $data->e_brand_name; ?>">
                    <input type="text" class="form-control text-capitalize" placeholder="<?= $this->lang->line('Ketik'); ?> <?= $this->lang->line('Nama Brand'); ?>" id="etype" name="etype" maxlength="30" autocomplete="off" required value="<?= $data->e_brand_name; ?>" autofocus>
                </div>
